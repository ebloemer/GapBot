...
const int rearExtendedRight = 547;                                          // Value for open position of rear arm
const int rearExtendedLeft = 1880;                                        // Value for closed position of rear arm
...
//            Bot.Stop("M1");                                                   // Stop Drive 1
         ...
         case 1: //Robot goes
         {
          rearPositionLeft = 900;
          rearPositionRight = 900;
          // Make sure all motion is stopped
          digitalWrite(LEFT_DRIVE_MOTOR_A, LOW);
            digitalWrite(RIGHT_DRIVE_MOTOR_A, LOW);
          Bot.Stop("M1");

          while(rearPositionLeft < rearExtendedLeft){
